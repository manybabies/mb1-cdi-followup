...
for(i in 1 : nrow(d1))  
{
  ...
  ##
  ##
  ##This is where I implemented the change for the 15 day correction
  ##
  ##
  ...
  if(score == 0)
  {
    perc_15plus = floor(perc_15plus / 2)
    print(perc_15plus)
  }
  perc <- perc_15plus
  ...
  ##
  ##
  ##Don't apply the 15 day correction to the Norwegian data.
  ##
  ##
