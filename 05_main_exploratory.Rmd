...
full.fe.re <- fe.re.tab(fe.model = "daily_percentile ~ IDS_pref * CDI.agerange + IDS_pref * method + IDS_pref * nae + gender", re = c("labid", "subid_unique"), data = data)
...
full <- glmmTMB(daily_percentile ~ z.IDS_pref * CDI.agerange + z.IDS_pref * method + z.IDS_pref * nae + gender + (1 |labid) + (1 | subid_unique), family = beta_family(link = "logit"), data = t.data)
...
coll_model <- lm(daily_percentile ~ z.IDS_pref + CDI.agerange + method + nae + gender, data = t.data)
library(car)
vif(coll_model)
...
null <- glmmTMB(daily_percentile ~ CDI.agerange + method + nae + gender + (1 | labid) + (1 | subid_unique), family = beta_family(link = "logit"), data = t.data)
...
full_no_int <- glmmTMB(daily_percentile ~ z.IDS_pref + CDI.agerange + method + nae + gender + (1 |labid) + (1 | subid_unique), family = beta_family(link = "logit"), data = t.data)
overdisp.test(full_no_int)

null_no_int <- glmmTMB(daily_percentile ~ CDI.agerange + method + nae + gender + (1 |labid) + (1 | subid_unique), family = beta_family(link = "logit"), data = t.data)
