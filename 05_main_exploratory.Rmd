...
full <- glmmTMB(vocabulary_percentile ~ z.ids_pref * z.test_age + z.ids_pref * z.cdi_age + z.ids_pref * protocol + z.ids_pref * nae + gender + (1 | lab) + (1 | participant), family = beta_family(link = "logit"), data=data)
