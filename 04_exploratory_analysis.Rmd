...
```{r}
ICC(mb1_excl2_icc, missing = FALSE, lmer = TRUE)

ICC(mb1_excl4_icc, missing = FALSE, lmer = TRUE)

ICC(mb1_excl6_icc, missing = FALSE, lmer = TRUE)

ICC(mb1_excl8_icc, missing = FALSE, lmer = TRUE)
```
