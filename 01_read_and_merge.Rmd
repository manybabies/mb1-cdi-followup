...
We then import the (pre-processed) data from the original Many Babies study on IDS preference, and chech for consistency of coding for `labid` and `subid`.
