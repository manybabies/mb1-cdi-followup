...
Checking by hand, we realize that the two duplicate data points for `babylablmu` result from a first entry with an error, and a second valid entry. The duplicate point for `unlv-musiclab` results from a similar error.
