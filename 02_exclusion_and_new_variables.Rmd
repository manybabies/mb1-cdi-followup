...
For our 3rd reseqrch question, we need to compute the proportional CDI scores as the raw score (number of words produced) divided by the total number of words in the CDI used.
